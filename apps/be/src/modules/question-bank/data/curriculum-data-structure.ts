  ...
  chapters: [
    ...
    },
    {
      ...
      keyConcepts: [
        ...
        { term: 'Deque(Double-ended Queue)', conceptLevel: 'Intermediate' },
        { term: 'Circular Queue', conceptLevel: 'Intermediate' },
        { term: 'Stack/Queue 활용(괄호 매칭, BFS)', conceptLevel: 'Intermediate' },
        { term: 'Priority Queue와 구현 비교', conceptLevel: 'Advanced' },
      ],
    },
    {
      chapter: 4,
      ...
      keyConcepts: [
        ...
        { term: 'AVL Tree / Red-Black Tree', conceptLevel: 'Intermediate' },
        { term: 'B-Tree / B+Tree', conceptLevel: 'Advanced' },
        { term: 'Trie(Prefix Tree)', conceptLevel: 'Advanced' },
      ],
    },
    {
      chapter: 5,
    ...
    },
    {
      ...
      keyConcepts: [
        ...
        { term: '최단 경로(Dijkstra, Bellman-Ford)', conceptLevel: 'Advanced' },
