...
const RewardModalContent = ({ data, onClose }: RewardModalContentProps) => {
  const { currentXp, requiredXp, level, gainedXp } = data;
  ...
  return (
    ...
    >
      ...
      <section className="flex flex-[1.2] flex-col justify-between p-10">
        <header>
          <h2 id="reward-title" className="mt-3 text-3xl font-extrabold text-black">
            학습 성과 리포트
          </h2>
          <p className="mt-1 text-sm text-dark-gray">오늘의 꾸준함이 모여 당신의 지식이 됩니다.</p>
        </header>
